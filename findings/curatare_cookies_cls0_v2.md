# Curățare cookies cls0 v2 — raport

**Versiune:** v2 (rezolvă banner-ul la mijloc/final și banner pur scăpat)

**Scope:** DOAR tratament boilerplate cookie, dar cu detecție robustă
indiferent de poziția banner-ului în text.
...
| Input brut | 6,047 |
| Nemodificate | 5,933 |
| Banner pur aruncat (scenariul 1) | 68 |
| Curățat prefix banner (scenariul 2) | 44 |
